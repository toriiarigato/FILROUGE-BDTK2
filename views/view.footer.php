...
<!------------------------------------------ Il prend cette partie + les balises fermantes body et html à la fin  ---------------------------------------------------->
 <!--Div d'aperçu-->
 <div id="colonne3" class="d-flex flex-column align-items-center justify-content-evenly border border-3 rounded rounded-3 shadow p-3 bg-body rounded m-2 column">
            <h2>Aperçu</h2>
            <img src="" id="pPic"></img>
            <h5>Titre:
        ...
        <div id="colonne4" class="d-none flex-column align-items-center justify-content-evenly border border-3 rounded rounded-3 shadow p-3 bg-body rounded m-2 column"></div>
        <div id="colonne5" class="d-none flex-column align-items-center justify-content-evenly border border-3 rounded rounded-3 shadow p-3 bg-body rounded m-2 column">
            </p>
        </div>
    </div>
...
<!------------------------------------------ Il prend cette partie + les balises fermantes body et html à la fin  ------------------------------------------------------>
    ...
    <div id="colonne3" class=" flex-column border border-3 rounded rounded-3 shadow p-3 bg-body rounded">
            ...
            <div>
                <p>
                    <div class="d-grid gap-2 bg-dark" id="blockbtn">
                        <a class="btn btn-primary bg-dark " data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Séries:
                    </a>
                    </div>
            ...
            <div>
                <p>
                    <div class="d-grid gap-2 bg-dark" id="blockbtn">
                        <a class="btn btn-primary bg-dark " data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">Auteur :
                    </a>
                    </div>
            ...
            <div>
                <p>
                    <div class="d-grid gap-2 bg-dark" id="blockbtn">
                        <a class="btn btn-primary bg-dark " data-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">Albums :
                    </a>
                    </div>
